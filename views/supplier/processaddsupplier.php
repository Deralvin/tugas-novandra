...
if(isset($_POST['Submit'])) {	
	...
	$tlp = $crud->escape_string($_POST['notelp']);
	$alamat = $crud->escape_string($_POST['alamat']);
	$ket = $crud->escape_string($_POST['keterangan']);

    $result = $crud->execute("INSERT INTO `supplier`(`nama_supplier`, `no_telp`, `alamat`, `keterangan`) VALUES ('$name','$tlp','$alamat','$ket')");
